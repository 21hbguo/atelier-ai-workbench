...
export const adminAPI = {
  ...
  square: (page = 1, size = 20, query) => { const params = { page, size }; if (query) params.query = query; return api.get('/admin/square', { params }) },
  deleteSquare: imageId => api.delete(`/admin/square/${imageId}`),
  prompts: (page = 1, size = 20, query) => { const params = { page, size }; if (query) params.query = query; return api.get('/admin/prompts', { params }) },
