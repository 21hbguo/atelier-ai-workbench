...
export default function GenerationCard({ task, onAddImage, onAddPrompt, onRetry, selectMode, checked, onToggleCheck, showUsername, username, onViewDetail, masonry = false }) {
