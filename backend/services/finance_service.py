...
class FinanceService:
    ...
    def record_task_entry(cls,task_id:str,status:str):
        with get_db() as conn:
            ...
            charged_points=float(task.get("points_cost") or 0)
