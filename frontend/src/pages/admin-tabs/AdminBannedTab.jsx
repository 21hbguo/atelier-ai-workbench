...
export default function AdminBannedTab({
  bannedWordsTotal, bannedWordsQuery, setBannedWordsQuery,
  setShowBatchImport, newBannedWord, setNewBannedWord,
  handleAddBannedWord, loading, bannedWords, handleDeleteBannedWord,
  bannedWordsPage, setBannedWordsPage
}) {
  return (
    <div>
