...
class ConfigUpdate(BaseModel):
    ...
    points_cost_per_generation: Optional[float] = Field(None, ge=0.0001)
    points_cost_per_optimize: Optional[float] = Field(None, ge=0.0001)
    points_cost_per_optimize_refine: Optional[float] = Field(None, ge=0.0001)
    points_cost_per_chat: Optional[float] = Field(None, ge=0.0001)
    chat_context_max_chars: Optional[int] = Field(None, ge=1000)
    points_cost_per_image_extend: Optional[float] = Field(None, ge=0.0001)
