...
class TitleGenerator:
    @classmethod
    async def _ask(cls,user_content:str)->str:
        # 起标题无需思考链：关闭 thinking（DeepSeek 默认开启思考会占满小 max_tokens 导致 content 为空）
