...
import { RefreshCw, Check, Plus, Image, Share2, User, BookOpen } from 'lucide-react'
...
export default function GenerationCard({ task, onAddImage, onAddPrompt, onAddToPromptLibrary, onRetry, selectMode, checked, onToggleCheck, wasDraggedRef, showUsername, username, onViewDetail, masonry = false, ...rest }) {
